...
class SimpleSystem:
 ...
 def __init__(self):
  ...
  self.param_K = rospy.get_param("/system_param_K",1.75)
  self.param_T = rospy.get_param("/system_param_T",0.5)
  ...
  #System
   ...
   if dt >= self.sample_time:
    ...
    #Dynamic System
      ...
      self.proc_output+= (-1.0/self.param_T * self.proc_output + self.param_K/self.param_T * self.Input.input) * dt    
